...
namespace Repository
{
    public class InviteUserRepository : BaseRepository<InviteUser>, IInviteUserRepository
    {
        ...
        public List<InviteUserDataVM> List(DatatableParams datatableParams)
        {
            ...
            string sql = $"EXEC dbo.GetInvitedUsersList '{ datatableParams.SearchText }', { datatableParams.Start }, {datatableParams.Length},'{datatableParams.SortOrderColumn}','{datatableParams.OrderType}', {datatableParams.CompanyId}";
